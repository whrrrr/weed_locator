    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'weed_locator.srv.MoveJoint_Request')
            logger.debug(
    ...
    def joint_id(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 256, \
                "The 'joint_id' field must be an unsigned integer in [0, 255]"
...
class Metaclass_MoveJoint_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'weed_locator.srv.MoveJoint_Response')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_MoveJoint(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from weed_locator.srv import _move_joint
...
class MoveJoint(metaclass=Metaclass_MoveJoint):
    from weed_locator.srv._move_joint import MoveJoint_Request as Request
    from weed_locator.srv._move_joint import MoveJoint_Response as Response
